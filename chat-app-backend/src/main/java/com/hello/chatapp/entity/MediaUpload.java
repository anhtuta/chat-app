...
public class MediaUpload {
    ...
    /**
     * Public id for this prepared attachment within an upload session.
     * Generated by the backend at prepare time ({@code UUID}) and stored here as {@code upload_id}.
     * <p>
     * Exposed to clients as {@code attachmentId} in prepare/parts/complete API payloads — same value,
     * different name. Not the MinIO/S3 multipart upload id (see {@link #multipartUploadId}).
     * Also distinct from the DB primary key {@link #id} and from {@link #uploadSessionId}, which groups
     * one or more attachments into a single future message.
     */
